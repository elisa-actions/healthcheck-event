...
const sendEvent = (token, resourceId, event) => __awaiter(void 0, void 0, void 0, function* () {
    const healthcheckUrl = 'https://healthcheck.csf.elisa.fi';
    const maxRetries = 5;
    let retryCount = 0;
    while (retryCount < maxRetries) {
        try {
            yield axios_1.default.post(`${healthcheckUrl}/api/v1/resources/${resourceId}/events`, event, {
                headers: {
            ...
            retryCount++;
            core.error(`Sending event failed: ${error.message}`);
...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            yield sendEvent(idToken, resourceId, body);
        }
        catch (error) {
