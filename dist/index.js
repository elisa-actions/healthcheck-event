...
const sendEvent = (healthcheckUrl, token, resourceId, event) => __awaiter(void 0, void 0, void 0, function* () {
    const maxRetries = 3;
    let retryCount = 0;
    const http = new httpm.HttpClient('healthcheck-event-action');
    while (retryCount < maxRetries) {
        try {
            yield http.post(`${healthcheckUrl}/api/v1/resources/${resourceId}/events`, JSON.stringify(event), {
...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const healthcheckUrl = 'https://mgrkm4ait3.execute-api.eu-central-1.amazonaws.com/prod/test';
            ...
            if (!['deploy', 'incident'].includes(event)) {
                core.setFailed(`Invalid event type: ${event}. Must be one of: deploy, incident`);
                return;
            }
            const body = {
                message,
            ...
            yield sendEvent(healthcheckUrl, idToken, resourceId, body);
        }
        catch (error) {
